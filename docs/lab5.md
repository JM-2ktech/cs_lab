...
**커넥터는 손입니다.** [Lab 2](./lab2.html)에서 날씨 질문이 막혔던 것은 에이전트가 몰라서가 아니라 수단이 없어서였습니다.

{: .important }
**읽는 손과 쓰는 손은 무게가 다릅니다.** 읽기는 틀려도 화면 안에서 끝나지만, 쓰기는 데이터의 변경에 의해 외부의 결과가 바뀝니다. 이 랩은 읽기로 시작해 쓰기로 끝나고, **마지막에 그 차이가 무엇을 뜻하는지** 직접 실습하게 됩니다.
